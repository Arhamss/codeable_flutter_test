...
Welcome! This is a timed take-home task. Please read the instructions below **before you start**.

### 🎨 Design

Implement the screens from this Figma file:

**➡️ [Codeable Flutter Test — Figma Design](https://www.figma.com/design/M6igkxLp0fJoZWiLWVTfMx/Codeable-Flutter-Test?node-id=0-1&t=iekH78q8urknpCTw-1)**

### ⏱️ Rules

- **Time limit:** You have **1 hour** to complete the task.
- **AI is allowed.** Use any AI tools you like (Claude, Copilot, ChatGPT, etc.).
- **Questions are allowed.** If you're stuck, you may ask and I'll answer — **but every answer I give counts against you** (it goes in your negative). So try to figure things out on your own first.
...
The release build uses a keystore at `android/app/codeable_flutter_test-keystore.jks` configured in `android/key.properties`.
